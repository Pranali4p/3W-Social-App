...
function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post("http://localhost:5000/auth/register", { username: name, email, password });
      ...
      >
        ...
        >
          <Typography variant="h4" mb={2} textAlign="center" sx={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
            <PersonAdd sx={{ mr: 1 }} /> Join 3W Social
          </Typography>
          ...
          <Box textAlign="center" mt={2}>
            <Typography variant="body2">
              ...
              <Link href="/login" color="#ff6b6b" sx={{ fontWeight: "bold" }}>
                Login here
              </Link>
            </Typography>
          </Box>
